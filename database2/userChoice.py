...
def userChoice(nameOfVideo, kindOfGas) :
    video_object = cv2.VideoCapture("C:\\Users\\Naomie\\Documents\\hackatal Video\\"+nameOfVideo+".mp4")
    ...
    while success:
        ...
        if success:
            ...
            #mpimg.imsave(r"C:/Users/קרן/Documents/Hackatal/img"+"_"+str(i)+".jpg",frame)
